...
\begin{block}{Spark}
\justifying{
Spark est un ensemble d’outils, personnalisations et fonctionnalités intégrées. \\~\\Spark est destiné à permettre aux utilisateurs de personnaliser leur expérience, d’hacker tout ce qu’ils veulent Source.
}
\end{block} 
\end{frame}
...
\\~\\Il se concentre sur des bidouillages cool que les membres de la communauté ont produit et sur des applications remplaçables.
}
\end{block} 
\end{column}
\begin{column}{5cm}
